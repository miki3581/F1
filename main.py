...
def main():
    ...
    # Saving a copy before dropping names for One-Hot Encoding
    df_unencoded = df_tar.copy()
    
    # Enocoding caterogical features
    ...
    # Predicting the exact finishing order for the most recent race in our test set
